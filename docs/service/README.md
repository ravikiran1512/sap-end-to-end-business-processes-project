...
- Service-related organizational and process setup
- Relevant service master-data dependencies
- Customer service/request processing
- Service execution and fulfillment activities
- Service-related confirmations and transactional data
- Relevant billing or settlement dependencies where applicable
...
- **MM** — materials and spare-parts dependencies where applicable
- **SD** — customer and sales-process relationships where applicable
